...
Section_01RootPath=/home/paulo/Workspace/Game-Development/Unreal/The-Unreal-Engine-Developer-Course/Section_01

gameProjectFile=/home/paulo/Workspace/Game-Development/Unreal/The-Unreal-Engine-Developer-Course/Section_01/Section_01.uproject
...
include(Section_01Source.pri)
include(Section_01Header.pri)
include(Section_01Config.pri)
include(Section_01Includes.pri)
include(Section_01Defines.pri)
...
Section_01-Linux-Debug.commands = $$build Section_01 Linux Debug  -project="\"$$gameProjectFile\"" $$args
Section_01-Linux-DebugGame.commands = $$build Section_01 Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Section_01-Linux-Shipping.commands = $$build Section_01 Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Section_01-Linux-Test.commands = $$build Section_01 Linux Test  -project="\"$$gameProjectFile\"" $$args
Section_01.commands = $$build Section_01 Linux Development  -project="\"$$gameProjectFile\"" $$args

Section_01Editor-Linux-Debug.commands = $$build Section_01Editor Linux Debug  -project="\"$$gameProjectFile\"" $$args
Section_01Editor-Linux-DebugGame.commands = $$build Section_01Editor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Section_01Editor-Linux-Shipping.commands = $$build Section_01Editor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Section_01Editor-Linux-Test.commands = $$build Section_01Editor Linux Test  -project="\"$$gameProjectFile\"" $$args
Section_01Editor.commands = $$build Section_01Editor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	UE4Server \
	Section_01-Linux-Debug \
	Section_01-Linux-DebugGame \
	Section_01-Linux-Shipping \
	Section_01-Linux-Test \
	Section_01 \
	Section_01Editor-Linux-Debug \
	Section_01Editor-Linux-DebugGame \
	Section_01Editor-Linux-Shipping \
	Section_01Editor-Linux-Test \
	Section_01Editor \
