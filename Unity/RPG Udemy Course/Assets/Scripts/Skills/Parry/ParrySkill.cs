...
public class ParrySkill : Skill
{
    ...
    public override void UseSkill()
    {
        ...
        if (restoreUnlocked) 
        { 
            int restoreAmount = Mathf.RoundToInt(player.characterStats.GetMaxHealthValue() * restoreHealthPercentage);
    ...
    protected override void Start()
    {
        ...
        parryWithMirageUnlockButton.GetComponent<Button>().onClick.AddListener(UnlockParryWithMirrage);
    }
