...
public class ArcherBattleState : EnemyState
{
    ...
    private int moveDir;
    public ArcherBattleState(Enemy enemyBase, EnemyStateMachine stateMachine, string animationBoolName, EnemyArcher enemy) : base(enemyBase, stateMachine, animationBoolName)
    {
        this.enemy = enemy;
    }
